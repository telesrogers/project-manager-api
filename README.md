...
Task management project developed as part of the **NODE.JS APPLICATION ARCHITECTURE** course, from the **DISTRIBUTED SOFTWARE ARCHITECTURE** postgraduate program at **PUC Minas**.
